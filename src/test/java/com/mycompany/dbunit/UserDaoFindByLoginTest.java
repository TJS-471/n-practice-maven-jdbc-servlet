...
public class UserDaoFindByLoginTest extends DBUnitConfig {

	public UserDaoFindByLoginTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		...
		beforeData = new FlatXmlDataSetBuilder()
				.build(Thread.currentThread().getContextClassLoader().getResourceAsStream("datasetUserFindByLoginTest.xml"));
	...
	public void testCreate() throws Exception {
        ...
        // connection to expected db result
                ...
                .build(Thread.currentThread().getContextClassLoader().getResourceAsStream("expectedFindByLoginTest.xml"));
        ...
        ITable actualDataTable = tester.getConnection().createQueryTable("result_name", "SELECT * FROM users_tb WHERE login = 'john';");
